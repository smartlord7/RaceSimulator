...
#define TOKENIZE_EXCEPTION "TOKENIZE_EXCEPTION: COULDN'T TOKENIZE FIELD %s!"
...
#define FILE_OPEN_EXCEPTION "FILE_OPEN_EXCEPTION: COULDN'T OPEN FILE %s!"
#define FILE_WRITE_EXCEPTION "FILE_WRITE_EXCEPTION: COULDN'T WRITE ON FILE %s!"
#define FILE_CLOSE_EXCEPTION "FILE_CLOSE_EXCEPTION: COULDN'T CLOSE FILE %s!"
...
#define COND_VAR_SIGNAL_EXCEPTION "COND_VAR_SIGNAL_EXCEPTION: COULDN'T SIGNAL CONDITION VARIABLE!"
...
#define NAMED_PIPE_DESTROY_EXCEPTION "NAMED_PIPE_DESTROY_EXCEPTION: COULDN'T DESTROY NAMED PIPE %s!"
#define NAMED_PIPE_OPEN_EXCEPTION "NAMED_PIPE_OPEN_EXCEPTION: COULDN'T OPEN NAMED PIPE %s!"
#define FILE_DESCRIPTOR_CLOSE_EXCEPTION "FILE_DESCRIPTOR_CLOSE_EXCEPTION: COULDN'T CLOSE FILE DESCRIPTOR %d!"
#define STREAM_READ_EXCEPTION "STREAM_READ_EXCEPTION: COULDN'T READ FROM STREAM WITH THE FD %d!"
#define STREAM_WRITE_EXCEPTION "STREAM_WRITE_EXCEPTION: COULDN'T WRITE TO THE STREAM WITH FD %d!"
#define PIPE_FAILED_WRITE_EXCEPTION "PIPE_FAILED_WRITE_EXCEPTION: COULDN'T WRITE ON %s!"
#define MS_SLEEP_EXCEPTION "MS_SLEEP_EXCEPTION: COULDN'T PERFORM SYS CALL TO SLEEP!"

#define FILE_STATS_EXCEPTION "FILE_STATS_EXCEPTION: COULDN'T READ FILE STATS!"
#define FILE_TRUNC_EXCEPTION "FILE_TRUNC_EXCEPTION: COULDN'T CHANGE FILE SIZE!"
#define MMAP_CREATE_EXCEPTION "MMAP_CREATE_EXCEPTION: COULDN'T CREATE MEMORY MAPPED FILE!"
#define MMAP_REMAP_EXCEPTION "MMAP_REMAP_EXCEPTION: COULDN'T REMAP MEMORY MAPPED FILE!"
#define MMAP_DESTROY_EXCEPTION "MMAP_DESTROY_EXCEPTION: COULDN'T DESTROY MEMORY MAPPED FILE!"
...
#define THREAD_EXIT_EXCEPTION "THREAD_EXIT_EXCEPTION: COULDN'T EXIT THREAD!"
